...
def convert_suggestion_to_cli_args(suggestion: Dict[str, Any], prefix: str = "") -> list[str]:
    """Convert a nested dictionary suggestion to Hydra command-line arguments."""
    args = []
    ...
    for key, value in suggestion.items():
        ...
        if isinstance(value, dict):
            ...
            args.extend(convert_suggestion_to_cli_args(value, full_key))
        else:
