...
from metta.agent.components.cross_attention_transformer import CrossAttentionTransformerConfig
...
class ViTCrossAttentionTransConfig(PolicyArchitecture):
    ...
    components: List[ComponentConfig] = [
        ...
        CrossAttentionTransformerConfig(
