...
class TaskTracker:
    ...
    def __init__(
        ...
        ema_alpha: float = 0.1,
        backend: TaskMemoryBackend | None = None,
    ...
    def track_task_creation(
        ...
        generator_type: float | None = None,
    ) -> None:
    ...
    def get_task_stats(self, task_id: int) -> dict[str, float] | None:
...
def LocalTaskTracker(max_memory_tasks: int = 1000, ema_alpha: float = 0.1) -> TaskTracker:  # noqa: N802
...
def CentralizedTaskTracker(  # noqa: N802
    max_memory_tasks: int = 1000,
    session_id: str | None = None,
    ema_alpha: float = 0.1,
