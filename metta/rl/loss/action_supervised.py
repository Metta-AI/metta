...
class ActionSupervisedConfig(LossConfig):
    ...
    sample_enabled: bool = False  # True means sequentially sample from the buffer during train in this loss
    rollout_forward_enabled: bool = False  # Control the rollout. If true, ensure ppo_critic is not also running rollout
    train_forward_enabled: bool = False  # Forward policy during training. Same as above re PPO concurency collisions.
