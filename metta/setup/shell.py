...
def help_configs() -> None:
    ...
    info('artifact = CheckpointManager.load_from_uri("file://./train_dir/my_run/checkpoints/my_run:v12.mpt")')
    info('artifact = CheckpointManager.load_from_uri("s3://bucket/path/my_run/checkpoints/my_run:v12.mpt")')
    info('policy = artifact.policy  # or artifact.instantiate(env_metadata)')
