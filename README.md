...
env = MettaGridGymEnv(mg_config=make_arena(num_agents=1))
...
- `mettagrid/demos/` - Framework-specific demos
- `experiments/recipes/` - Training configurations
- [MettaGrid Environment Documentation](mettagrid/README.md)
