...
./devops/skypilot/launch.py train run=daphne.nav_memory_sequence.object_use_finetuned.06-25 trainer.curriculum=env/mettagrid/curriculum/nav_memory_sequence --gpus=1 --skip-git-check trainer.initial_policy.uri=wandb://run/daphne.object_use.06-25 \
