"""Small-map reward-shaped preset entry points."""

from __future__ import annotations

from typing import Optional, Sequence

from experiments.recipes.cvc_shaped import DEFAULT_VARIANTS, play as preset_play, train_small_maps as preset_train
