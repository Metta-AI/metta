...
def help_configs() -> None:
    ...
    info('artifact = load_policy_artifact("file://./train_dir/my_run/checkpoints/my_run:v12.mpt")')
    info('artifact = load_policy_artifact("s3://bucket/path/my_run/checkpoints/my_run:v12.mpt")')
