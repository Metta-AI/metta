...
def _create_test_db_with_missing_metrics(db_path: Path) -> TestEvalStatsDb:
    ...
    checkpoint_filename = "test_policy/checkpoints/v1.pt"
...
def test_no_metrics(test_db: TestEvalStatsDb) -> None:
    ...
    invalid_uri = CheckpointManager.normalize_uri("/tmp/none/checkpoints/v99.pt")
...
def test_empty_database():
    with tempfile.TemporaryDirectory() as tmp:
        ...
        test_uri = CheckpointManager.normalize_uri("/tmp/test/checkpoints/v1.pt")
