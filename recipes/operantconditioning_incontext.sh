...
./devops/skypilot/launch.py train \
  run=$USER.operant_conditioning.in_context_learning.all_chains_no_sinks.0.2_progress_smoothing.$(date +%m-%d) \
...
./devops/skypilot/launch.py train \
  run=$USER.operant_conditioning.in_context_learning.all_chains_one_sink.0.2_progress_smoothing.$(date +%m-%d) \
...
# 4 converters
./devops/skypilot/launch.py train \
  run=$USER.operant_conditioning.in_context_learning.all.0.2_progress_smoothing.$(date +%m-%d) \
...
./devops/skypilot/launch.py train \
  run=$USER.operant_conditioning.in_context_learning.chains_2_3_allsinks.0.2_progress_smoothing.$(date +%m-%d) \
