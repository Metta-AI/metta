...
class MambaBackboneConfig(metta.agent.components.component_config.ComponentConfig):
    ...
    n_layer: int = 4
    ssm_cfg: typing.Dict[str, typing.Any] = pydantic.Field(default_factory=dict)
    attn_layer_idx: typing.List[int] = pydantic.Field(default_factory=list)
    attn_cfg: typing.Dict[str, typing.Any] = pydantic.Field(default_factory=dict)
    ...
    def make_component(self, env: typing.Optional[typing.Any] = None):  # type: ignore[override]
        ...
        return metta.agent.components.mamba.backbone.MambaBackboneComponent(config=self, env=env)
    ...
    def resolved_ssm_cfg(self) -> typing.Dict[str, typing.Any]:
