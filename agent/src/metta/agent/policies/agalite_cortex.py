...
class AGaLiTeCortexConfig(PolicyArchitecture):
    """CortexTD-based AGaLiTe policy using ViT tokenization and Ag attention layers."""
    ...
    _eta = 4
    _r = 2
    _memory_num_layers = 2  # Ag layers; adjust as needed
    ...
    components: List[ComponentConfig] = [
        ...
        CortexTDConfig(
            ...
            key_prefix="agalite_cortex_state",
