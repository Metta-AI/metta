...
class PufferActor(LayerBase):
    ...
    def _forward(self, td: TensorDict):
        ...
        action_logits = torch.einsum('n h, n e -> n 1', hidden_reshaped, action_embeds_reshaped) # Shape: [N, A]
        action_logits = rearrange(action_logits, 'n 1 -> b a') # Shape: [B*TT, num_actions]
