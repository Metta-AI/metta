"""
PyTorch policy loading and adapter functionality.

This module provides the PytorchAgent adapter class for making external PyTorch policies
compatible with the MettaAgent interface, and functions for loading such policies.
"""
