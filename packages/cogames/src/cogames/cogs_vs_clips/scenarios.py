...
def games() -> dict[str, MettaGridConfig]:
    return {
        ...
        "biomes_candidate1_500_stations": make_game_from_map("canidate1_500_stations.map"),
        "biomes_candidate1_1000_stations": make_game_from_map("canidate1_1000_stations.map"),
        "biomes_candidate2_500_stations": make_game_from_map("canidate2_500_stations.map"),
        "biomes_candidate2_1000_stations": make_game_from_map("canidate2_1000_stations.map"),
        "biomes_candidate3_500_stations": make_game_from_map("canidate3_500_stations.map"),
        "biomes_candidate3_1000_stations": make_game_from_map("canidate3_1000_stations.map"),
        "biomes_candidate4_500_stations": make_game_from_map("canidate4_500_stations.map"),
    }
