...
class PufferEnv:
    def __init__(self, buf=None):
        ...
        if not isinstance(self.single_action_space, pufferlib.spaces.Discrete) and not isinstance(
            self.single_action_space, pufferlib.spaces.Box
        ):
            raise APIUsageError("Native action_space must be a Discrete or Box")
