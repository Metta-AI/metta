...
def simulations(env: Optional[MettaGridConfig] = None) -> list[SimulationConfig]:
    ...
    Combat mode is disabled for benchmarking - attacks cost 100 laser (effectively disabled).
    """
...
def sweep(sweep_name: str) -> SweepTool:
    ...
    Example usage:
        `uv run ./tools/run.py experiments.recipes.arena_prog_7.sweep sweep_name="ak.baes.10081528" -- gpus=4 nodes=2`

    We recommend running using local_test=True before running the sweep on the remote:
        `uv run ./tools/run.py experiments.recipes.arena_prog_7.sweep sweep_name="ak.baes.10081528.local_test" -- local_test=True`
    ...
    Running on the remote:
        ...
        6 - Launch the sweep: `uv run ./tools/run.py experiments.recipes.arena_prog_7.sweep sweep_name="ak.baes.10081528" -- gpus=4 nodes=2`
    ...
    return make_sweep(
        name=sweep_name,
        recipe="experiments.recipes.arena_prog_7",
