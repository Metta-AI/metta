...
def make_mettagrid(num_cogs: int = 24, width: int = 10, height: int = 10, num_assemblers: int = 1, num_chargers: int = 0, num_carbon_extractors: int = 0, num_oxygen_extractors: int = 0, num_germanium_extractors: int = 0, num_silicon_extractors: int = 0, num_chests: int = 0, dir = "packages/cogames/src/cogames/maps/") -> MettaGridConfig:
    env = make_game(num_cogs, width, height, num_assemblers, num_chargers, num_carbon_extractors, num_oxygen_extractors, num_germanium_extractors, num_silicon_extractors, num_chests)
    num_instances = 24 // num_cogs
    map_file = random.choice(["training_facility_open_1.map", "training_facility_open_2.map", "training_facility_open_3.map", "training_facility_tight_4.map", "training_facility_tight_5.map"])
...
def play(env: Optional[MettaGridConfig] = None) -> PlayTool:
    ...
    return PlayTool(sim=SimulationConfig(suite="facility_env", env=eval_env, name="eval"))
