...
class TestTribalEssentials(unittest.TestCase):
    ...
    def test_environment_creation(self):
        ...
        game_config = tribal.TribalGameConfig(
            max_steps=50, ore_per_battery=3, batteries_per_heart=2,
            enable_combat=True, clippy_spawn_rate=0.1, clippy_damage=1,
            heart_reward=1.0, ore_reward=0.1, battery_reward=0.5,
            survival_penalty=0.0, death_penalty=0.0
        )
