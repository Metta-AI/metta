...
public:
    ObservationEncoder() {
        ...
        for (auto type_id : {ObjectType::AltarT, ObjectType::ArmoryT, ObjectType::FactoryT, 
                           ObjectType::GeneratorT, ObjectType::LabT, ObjectType::LaseryT, 
                           ObjectType::MineT, ObjectType::TempleT}) {
