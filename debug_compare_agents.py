...
def create_env():
    ...
    from metta.rl.envpool import EnvListPool
    ...
    system_cfg = SystemConfig(device="cpu", vectorization="serial", num_envs=1)
    pool = EnvListPool(env_cfg.env, system_cfg)
    return pool.single_env
