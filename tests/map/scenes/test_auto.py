...
from metta.map.random.float import FloatConstantDistribution, FloatUniformDistribution
from metta.map.random.int import IntConstantDistribution, IntUniformDistribution
from metta.map.scenes.auto import (
    Auto,
    AutoParams,
    AutoParamsBSP,
    AutoParamsGrid,
...
from metta.map.scenes.random_scene import RandomSceneCandidate
