...
from softmax.orchestrator.auth import user_from_header_or_token
from softmax.orchestrator.leaderboard_updater import LeaderboardUpdater
from softmax.orchestrator.metta_repo import MettaRepo
from softmax.orchestrator.routes import (
    dashboard_routes,
    entity_routes,
    eval_task_routes,
    leaderboard_routes,
...
if __name__ == "__main__":
    from softmax.orchestrator.config import host, port, run_leaderboard_updater, stats_db_uri
