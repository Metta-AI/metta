...
trainer_config = TrainerConfig(
    num_workers=8,  # Adjusted for hardware cores
    ...
    kickstart=DictConfig(
        {
            "teacher_uri": None,  # Disable kickstart
...
while agent_step < trainer_config.total_timesteps:
    ...
    while not experience.ready_for_training:
        ...
        batch_steps = min(8, experience.batch_size - experience.num_steps)  # Process 8 steps at once
