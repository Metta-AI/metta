...
def main():
    ...
    if hasattr(launch_task, "main"):
        ...
        parser.add_argument(
            "--gpu-cpus", type=int, default=6, help="Number of CPUs per GPU (vCPUs will be 2x this value)."
        )
        ...
        parser.add_argument(
            "--dry-run", action="store_true", help="Dry run mode, prints job details without submitting."
        )
