...
for i in "${!POLICIES[@]}"; do
    ...
    python3 -m tools.sim \
        ...
        +eval_db_uri=wandb://stats/navigation_db_sharing_test \

python3 -m tools.dashboard +eval_db_uri=wandb://stats/navigation_db_sharing_test run=multiagentrugeorge ++analyzer.output_path=s3://softmax-public/policydash/navigation_sharing.html \
