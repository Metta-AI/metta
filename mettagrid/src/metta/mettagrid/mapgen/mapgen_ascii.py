...
from metta.mettagrid.mapgen.scenes.ascii import Ascii
...
class MapGenAscii(MapGen):
    ...
    game:
      map_builder:
        _target_: metta.mettagrid.mapgen.mapgen_ascii.MapGenAscii
    ...
    game:
      map_builder:
        ...
        border_width: 0
        root:
          type: metta.mettagrid.mapgen.scenes.ascii.Ascii
          params:
            uri: "path/to/my/map.map"
    ```
