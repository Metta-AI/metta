...
class MCActionProbs(nn.Module):
    ...
    def forward_inference(self, td: TensorDict) -> TensorDict:
        ...
        td["mc_actions"] = action_logit_index.to(dtype=torch.int32)
        td["mc_act_log_prob"] = selected_log_probs
        td["mc_full_log_probs"] = full_log_probs
    ...
    def forward_training(self, td: TensorDict, action: torch.Tensor) -> TensorDict:
        ...
        td["mc_act_log_prob"] = selected_log_probs
        td["mc_entropy"] = entropy
        td["mc_full_log_probs"] = action_log_probs
