...
_EXPORTS: dict[str, tuple[str, str | None]] = {
    ...
    "FutureLatentEMALossConfig": ("metta.rl.loss.future_latent_ema", "FutureLatentEMALossConfig"),
}

# Explicitly define __all__ to help type checkers
__all__ = ["LossConfig", "Loss", "PPOConfig", "ContrastiveConfig", "FutureLatentEMALossConfig"]
