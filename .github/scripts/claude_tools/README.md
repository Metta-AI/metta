...
A type annotation analyzer that helps Claude identify missing type annotations in Python code. **Commands:**
...
- `check <file.py>` - Run all checks and provide comprehensive summary **Features:**
- AST-based analysis to identify missing annotations
- Smart filtering to only report high-value annotations
- Structured JSON output for easy parsing
- Respects coding conventions (skips private methods, properties, etc.) **Usage in Claude workflows:**
