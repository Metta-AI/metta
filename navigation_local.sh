...
run="$USER.navigation.ffa_test_4rooms_of_2_positions_in_same_area_seed0.$(date +%m-%d)" \
...
++trainer.env_overrides.game.map_builder.room.agent_cluster_type=no_clustering \
