...
def python_ci(name: str = "python_ci", timeout_s: int = 1800) -> Task:
    """Create a Python CI task that runs 'metta pytest --ci'."""
    job_config = JobConfig(
        name=name,
...
def cpp_ci(name: str = "cpp_ci", timeout_s: int = 1800) -> Task:
    """Create a C++ CI task that runs 'metta cpptest --test'."""
    job_config = JobConfig(
        name=name,
        module="__unused__",  # Not used for command-based tasks
        execution="local",
...
def cpp_benchmark(name: str = "cpp_benchmark", timeout_s: int = 1800) -> Task:
    """Create a C++ benchmark task that runs 'metta cpptest --benchmark'."""
    job_config = JobConfig(
        name=name,
        module="__unused__",  # Not used for command-based tasks
        execution="local",
