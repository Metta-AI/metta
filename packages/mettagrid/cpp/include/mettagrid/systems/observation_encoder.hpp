      ...
      if (resource_names && feature_ids && !resource_names->empty()) {
        ...
        for (size_t i = 0; i < resource_names->size(); ++i) {
          ...
          if (input_it != feature_ids->end()) {
            ...
            throw std::runtime_error("Protocol input feature 'protocol_input:" + resource_name + "' not found in feature_ids");
          }
          ...
          if (output_it != feature_ids->end()) {
            ...
            throw std::runtime_error("Protocol output feature 'protocol_output:" + resource_name + "' not found in feature_ids");
          }
        }
      } else {
