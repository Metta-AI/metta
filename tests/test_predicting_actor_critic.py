...
class TestPredictingActorCritic(unittest.TestCase):
    def setUp(self):
        ...
        self.obs_space = {"obs": gym.spaces.Box(low=0, high=255, shape=(1, 2, 3), dtype=np.uint8)}
    ...
    def test_forward(self):
        ...
        self.actor_critic.obs_predictor.return_value = obs.view(batch_size, -1).to(torch.float32) + errors
