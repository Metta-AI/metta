...
def _rebuild_models():
    ...
    This is called from the package __init__.py after all modules are imported,
    to properly resolve forward references in Union types.
    """
    from metta.cogworks.curriculum.learning_progress_algorithm import LearningProgressConfig  # noqa: F401
