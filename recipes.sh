#NAVIGATION
./devops/skypilot/launch.py train run=georgedeane.navigation.baseline.06-20  trainer.curriculum=env/mettagrid/curriculum/navigation --no-spot --gpus=4 --skip-git-check \
