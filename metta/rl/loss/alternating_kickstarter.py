...
class AlternatingKickstarter(Loss):
    ...
    def run_train(
        ...
        self.loss_tracker["tl_action_loss_coef"].append(float(self.cfg.action_loss_coef))
        self.loss_tracker["tl_value_loss_coef"].append(float(self.cfg.value_loss_coef))
