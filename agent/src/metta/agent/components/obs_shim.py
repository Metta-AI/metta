...
class ObsTokenPadStrip(nn.Module):
    ...
    def forward(self, td: TensorDict) -> TensorDict:
        ...
        # Recreate the positions tensor on every call to avoid retaining CUDAGraph-managed
        # storage between compiled replays, which can lead to stale data access errors.
