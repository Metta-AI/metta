...
from cogames.tribal_village import train as tribal_train_module
...
def train_tribal_cmd(
    ctx: typer.Context,
    policy: str = typer.Option("tribal", "--policy", "-p", help=f"Policy ({policy_arg_example})"),
    checkpoints_path: str = typer.Option(
        "./train_dir",
        "--checkpoints",
        help="Path to save training data",
    ...
    env_config: dict[str, object] = {"max_steps": max_steps, "render_scale": render_scale, "render_mode": render_mode}
