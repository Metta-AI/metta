...
#NAVIGATION
./devops/skypilot/launch.py sweep run=daphne.navigation.sweep.06-19  trainer.curriculum=env/mettagrid/curriculum/navigation --no-spot --gpus=4 --skip-git-check \
