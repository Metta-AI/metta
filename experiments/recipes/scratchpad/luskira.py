...
# You can run these functions locally with e.g. `./tools/run.py experiments.recipes.scratchpad.luskira.train`
...
def evaluate(
    policy_uri: str = "s3://your-bucket/checkpoints/local.luskira.1/local.luskira.1:v10.pt",
) -> EvaluateTool:
