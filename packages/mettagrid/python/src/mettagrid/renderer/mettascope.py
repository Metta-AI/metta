        ...
        if self.response.actions:
            for action in self.response.actions:
                ...
                try:
                    ...
                    available_actions = [a for a in self._sim.action_ids.keys() if "change_glyph" in a]
                    print(f"Available change_glyph actions: {available_actions}")
                    continue
