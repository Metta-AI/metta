...
def test_pettingzoo_env_creation(simple_config):
    ...
    curriculum = single_task_tree("pettingzoo_test", simple_config)
...
def test_pettingzoo_env_reset(simple_config):
    ...
    curriculum = single_task_tree("pettingzoo_reset_test", simple_config)
    env = MettaGridPettingZooEnv(
        curriculum=curriculum,
        render_mode=None,
        is_training=False,
...
def test_pettingzoo_env_step(simple_config):
    ...
    curriculum = single_task_tree("pettingzoo_step_test", simple_config)
    env = MettaGridPettingZooEnv(
        curriculum=curriculum,
        render_mode=None,
        is_training=False,
...
def test_pettingzoo_env_agent_removal(simple_config):
    ...
    curriculum = single_task_tree("pettingzoo_removal_test", simple_config)
    env = MettaGridPettingZooEnv(
        curriculum=curriculum,
        render_mode=None,
        is_training=False,
...
def test_pettingzoo_env_spaces(simple_config):
    ...
    curriculum = single_task_tree("pettingzoo_spaces_test", simple_config)
    env = MettaGridPettingZooEnv(
        curriculum=curriculum,
        render_mode=None,
        is_training=False,
...
def test_pettingzoo_env_state(simple_config):
    ...
    curriculum = single_task_tree("pettingzoo_state_test", simple_config)
    env = MettaGridPettingZooEnv(
        curriculum=curriculum,
        render_mode=None,
        is_training=False,
