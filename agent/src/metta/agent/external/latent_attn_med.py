...
class Policy(nn.Module):
    def __init__(self, env, input_size=128, hidden_size=128):
        ...
        self.obs_latent_query_attn = ObsLatentAttn(
            out_dim=32, _feat_dim=45, use_mask=True, num_query_tokens=10, query_token_dim=32, num_heads=8, num_layers=3,
        )
        self.obs_latent_self_attn = ObsSelfAttn(
            out_dim=128, _feat_dim=32, num_heads=8, num_layers=3, use_mask=False, use_cls_token=True,
        )
