...
def emulate_action_space(space):
    ...
    raise ValueError(
        f"Metta Python integration only supports Discrete or Box action spaces; got {space.__class__.__name__}"
    )
...
class GymnasiumPufferEnv(gymnasium.Env):
    ...
    def step(self, action):
        ...
        # Convert emulated actions into the original action space
