...
- `cogames make-policy --scripted` gives a starter template for a simple, rule-based script
- `cogames make-policy --trainable` gives a basic neural-net based implementation that can be trained via
  `cogames train`
