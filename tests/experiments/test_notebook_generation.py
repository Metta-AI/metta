...
class TestNotebookGeneration:
    ...
    def test_notebook_contains_requested_sections(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            filepath = generate_notebook(
                name="selective_notebook", sections=["setup", "launch", "monitor"], output_dir=tmpdir
            )
    ...
    def test_research_notebook_starts_empty(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            filepath = generate_notebook(
                name="research_notebook", description="For exploratory research", output_dir=tmpdir
            )
    ...
    def test_notebook_includes_working_imports(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            filepath = generate_notebook(name="import_test", sections=["setup", "metrics"], output_dir=tmpdir)
