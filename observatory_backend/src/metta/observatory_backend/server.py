...
from metta.observatory_backend.auth import user_from_header_or_token
from metta.observatory_backend.metta_repo import MettaRepo
from metta.observatory_backend.routes import dashboard_routes, sql_routes, stats_routes, token_routes
...
if __name__ == "__main__":
    from metta.observatory_backend.config import host, port, stats_db_uri
