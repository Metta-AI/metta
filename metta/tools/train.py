...
from metta.common.util.log_config import getRankAwareLogger, init_logging, _init_console_logging
...
# Ensure the RankAwareLogger class is set before creating any loggers
