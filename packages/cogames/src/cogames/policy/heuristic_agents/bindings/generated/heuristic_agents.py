import os
import sys
from ctypes import *  # noqa: F403, F405
...
dll = cdll.LoadLibrary(os.path.join(dir, libName))  # noqa: F405
...
class HeuristicAgent(Structure):  # noqa: F405
    _fields_ = [("ref", c_ulonglong)]  # noqa: F405
...
dll.heuristic_agents_new_heuristic_agent.argtypes = [c_longlong, c_char_p]  # noqa: F405
dll.heuristic_agents_new_heuristic_agent.restype = c_ulonglong  # noqa: F405

dll.heuristic_agents_heuristic_agent_get_agent_id.argtypes = [HeuristicAgent]
dll.heuristic_agents_heuristic_agent_get_agent_id.restype = c_longlong  # noqa: F405

dll.heuristic_agents_heuristic_agent_set_agent_id.argtypes = [HeuristicAgent, c_longlong]  # noqa: F405
...
dll.heuristic_agents_heuristic_agent_step.argtypes = [  # noqa: F405
    HeuristicAgent,
    c_longlong,  # noqa: F405
    c_longlong,  # noqa: F405
    c_longlong,  # noqa: F405
    c_void_p,  # noqa: F405
    c_longlong,  # noqa: F405
