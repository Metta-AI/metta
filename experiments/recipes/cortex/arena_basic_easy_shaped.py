...
def _override_cortex_stack(policy_cfg: CortexBaseConfig, stack) -> CortexBaseConfig:
    comps = []
...
def sweep_async_progressive(
    ...
    return SweepTool(
        ...
        # Recipe entrypoints
        recipe_module="experiments.recipes.cortex.arena_basic_easy_shaped",
