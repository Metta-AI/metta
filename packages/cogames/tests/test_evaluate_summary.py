...
from cogames.evaluate import RawMissionEvaluationResult, _build_results_summary
...
def test_build_results_summary_multi_mission_policy_episode() -> None:
    ...
    mission_one = RawMissionEvaluationResult(
    ...
    mission_two = RawMissionEvaluationResult(
        ...
        per_episode_stats=[
            {
                ...
                "agent": [
                    {"stat_a": 3.0},
                    {"stat_a": 2.0, "stat_b": 1.0},
                    {"stat_a": 4.0, "stat_b": 2.0},
                ],
            },
            {
                "game": {"game_metric": 6.0},
                "agent": [
                    {"stat_a": 3.0, "stat_b": 1.0},
                    {"stat_a": 4.0},
                    {"stat_a": 4.0, "stat_b": 2.0},
                ],
            },
