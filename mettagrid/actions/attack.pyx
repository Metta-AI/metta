    ...
    cdef bint _handle_action(
        ...
        if agent_target:
            ...
            if agent_target.shield:
                ...
                self.env._stats.agent_add(actor_id, actor.species_name + b".shield_damage", shield_damage)
            if shield_damage < actor.attack_damage:
                ...
                self.env._stats.agent_incr(actor_id, b"attack.frozen")
                self.env._stats.agent_incr(actor_id, actor.species_name + b".attack.frozen")
        ...
        if object_target:
            ...
            object_target.hp -= 1
            self.env._stats.agent_incr(actor_id, b"damage." + ObjectTypeNames[object_target._type_id])
            self.env._stats.agent_incr(actor_id, actor.species_name + b".damage." + ObjectTypeNames[object_target._type_id])
