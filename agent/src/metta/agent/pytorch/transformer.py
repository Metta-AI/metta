"""
Transformer agent for Metta with proper observation encoding and action decoding.

This is the stable baseline transformer that correctly implements:
...
4. Proper normalization and initialization for transformers
"""
...
class Transformer(PyTorchAgentMixin, TransformerWrapper):
    """Transformer agent with proper observation encoding and action decoding.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        logger.info("Initializing Transformer agent...")
        ...
        logger.info("Transformer agent initialization complete")
