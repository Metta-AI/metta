...
# Import base classes - must be after curriculum module exists
from agora.curriculum import CurriculumAlgorithm, CurriculumAlgorithmConfig
from agora.tracking.stats import CacheCoordinator, LPStatsAggregator
from agora.tracking.tracker import TaskTracker

if TYPE_CHECKING:
    from agora.curriculum import CurriculumTask
...
class LearningProgressConfig(CurriculumAlgorithmConfig):  # type: ignore[name-defined]
    ...
    session_id: str | None = None  # Session ID for shared memory, None = auto-generate unique
