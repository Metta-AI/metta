...
from cogames.cogs_vs_clips.procedural import MachinaArena as ProceduralMachinaArena, RandomTransform
from cogames.cogs_vs_clips.sequential import MachinaArena as SequentialMachinaArena
