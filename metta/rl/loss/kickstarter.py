...
class SLKickstarter(BaseLoss):
    ...
    __slots__ = (
        "teacher_policy",
        "teacher_policy_specaction_loss_coef",
        "value_loss_coef",
        "begin_at_step",
        "end_at_step",
    )
...
#         # av does this create a new td?
#         td = shared_loss_data["PPO"]["sampled_mb"].select(self.teacher_policy_spec)
#         teacher_value = td["value"]
#         teacher_normalized_logits = td["full_log_probs"]

#         # av check this
#         student_normalized_logits = shared_loss_data["PPO"]["sampled_mb"]["full_log_probs"]
#         student_value = shared_loss_data["PPO"]["sampled_mb"]["value"]
