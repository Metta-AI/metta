...
def train(*, num_cogs: int = 4) -> metta.tools.train.TrainTool:
    """Train on the small-map curriculum with a configurable number of agents."""
    return experiments.recipes.cvc.core.train_small_maps(num_cogs=num_cogs)
...
def play(
    *,
    ...
    """Play a default small-map mission."""
