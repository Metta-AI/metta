"""
Unified command runner for git operations.

This module provides a single, hardened subprocess runner for all git commands
with consistent error handling, environment setup, and logging.
"""
