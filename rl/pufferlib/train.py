...
class PufferTrainer:
    def __init__(self, cfg: OmegaConf, dashboard: Dashboard):
        ...
        self.dashboard.set_policy(self.policy)

        self.profile = Profile()
        self.dashboard.profile = self.profile
    ...
    def train(self):
        ...
        while self.global_step < self.train.total_timesteps:
            self._evaluate()
            self._train()

        train_time = time.time() - train_start
        self.close()
        return self.last_stats, train_time
    ...
    def _evaluate(self):
        ...
        while not experience.full:
            ...
            with profile.eval_misc:
                ...
                o = o if self.cfg.cpu_offload else o_device
    ...
    def _train(self):
        experience, profile = self.experience, self.profile
        losses = self._make_losses()
        self.dashboard.losses = losses
    ...
    def _maybe_save_checkpoint(self):
        ...
        if self.epoch % self.cfg.train.checkpoint_interval == 0 or done_training:
