...
#define NUMPY_TERMINALS_TYPE "bool"      // match c_terminals_type
#define NUMPY_TRUNCATIONS_TYPE "bool"    // match c_truncations_type
...
#define NUMPY_SUCCESS_TYPE "bool"        // match c_success_type
