...
SWEEP_DIMENSIONS: Sequence[SweepDimension] = (
    SweepDimension("training_env.curriculum.algorithm_config.ema_timescale", [0.001, 0.005, 0.01]),
    SweepDimension("training_env.curriculum.algorithm_config.z_score_amplification", [5, 10, 15]),
    SweepDimension("training_env.curriculum.algorithm_config.exploration_bonus", [0.05, 0.1]),
)
