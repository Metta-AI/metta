...
# Dual-Policy Training Recipe with Mixed Reward Strategy
# This recipe trains a new policy with a mixed facilitator/original reward (coef=0.75)

set -e

# Configuration
BASE_RUN_NAME="dual_policy_mixed"
...
echo "Starting dual-policy training with mixed reward strategy (coef=0.75)"
