#!/usr/bin/env python3
"""
Real Curriculum Analysis Demo with Hydra

This script demonstrates the curriculum analysis framework using
real curriculum implementations from the codebase with proper Hydra setup.
"""
...
def create_analysis_config(curriculum_name: str, curriculum_path: str) -> DictConfig:
    ...
    config_dict = {
        "analysis_mode": True,
        "analysis_epochs": 3,  # Small number for demo
        "analysis_tasks_per_epoch": 2,
...
def run_curriculum_analysis_with_hydra(cfg: DictConfig, curriculum_name: str, curriculum_path: str) -> Dict:
    """Run curriculum analysis on a real curriculum with proper Hydra setup."""
...
def main():
    ...
    for curriculum_name, config in curriculum_configs.items():
        ...
        try:
            # Use Hydra to run the analysis
            results = run_curriculum_analysis_with_hydra(
