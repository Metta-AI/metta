...
# Note: Heartbeat monitoring is handled by the training process itself (train.sh)
# The sweep orchestrator doesn't need its own heartbeat since it blocks on training
