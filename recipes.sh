#NAVIGATION
./devops/skypilot/launch.py train run=daphnedemekas.navigation.bucketed.06-20.2  trainer.curriculum=env/mettagrid/curriculum/navigation --no-spot --gpus=4 --skip-git-check \
...
#NAV-MEMORY-SEQUENCE
./devops/skypilot/launch.py train run=daphne.demekas.nav_memory_sequence.bucketed.06-20.2  trainer.curriculum=env/mettagrid/curriculum/nav_memory_sequence --no-spot --gpus=4 --skip-git-check \
