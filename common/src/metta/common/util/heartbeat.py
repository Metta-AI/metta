...
def record_heartbeat() -> None:
    ...
    This function is optimized for both local and S3-backed filesystems.
    It only touches the file to update mtime, avoiding file recreation.
    """
    ...
    try:
        ...
        # Periodic logging for debugging (once per minute)
