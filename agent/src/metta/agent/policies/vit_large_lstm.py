...
class ViTLargeLSTMConfig(PolicyArchitecture):
    """ViT variant with larger LSTM (256 wide, 2 layers), actor (512), and critic (1024)."""
    ...
    _actor_hidden = 512  # Increased from 256
