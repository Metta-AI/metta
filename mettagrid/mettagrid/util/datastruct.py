"""
Utility functions for manipulating nested data structures.
These are copies of functions from the metta package to allow mettagrid
to be used independently without requiring the full metta installation.
"""
...
def unroll_nested_dict(d):
    """
    Recursively unroll a nested dictionary using '/' as separator.
    ...
    Args:
        d: Dictionary to unroll
        
    Yields:
        Tuple of (key_path, value) pairs
    """
