...
class TestTribalBindings(unittest.TestCase):
    ...
    def test_observations(self):
        ...
        # Check size
        expected_size = tribal.MAP_AGENTS * tribal.OBSERVATION_LAYERS * tribal.OBSERVATION_HEIGHT * tribal.OBSERVATION_WIDTH
        ...
        obs_reshaped = obs_array.reshape(
            tribal.MAP_AGENTS,
            tribal.OBSERVATION_LAYERS, 
            tribal.OBSERVATION_HEIGHT,
            tribal.OBSERVATION_WIDTH
        )
