...
run=$USER.operantconditioning.smoke_test.2_converters.$(date +%m-%d) \
...
./devops/skypilot/launch.py train \
run=$USER.operantconditioning.smoke_test.3_converters.$(date +%m-%d) \
...
./devops/skypilot/launch.py train \
run=$USER.operantconditioning.smoke_test.4_converters.$(date +%m-%d) \
...
./devops/skypilot/launch.py train \
run=$USER.operantconditioning.smoke_test.all_converters.$(date +%m-%d) \
