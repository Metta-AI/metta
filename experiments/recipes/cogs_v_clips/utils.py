...
foraging_curriculum_args = {
    ...
    "assembly_lines_chests_combined": {
        ...
        "num_chests": [1],
        "size": [4],
        "assembler_positions": num_agents_to_positions[2] + num_agents_to_positions[3] + num_agents_to_positions[4],
        "extractor_positions": [
            num_agents_to_positions[2] + num_agents_to_positions[3] + num_agents_to_positions[4],
        ],
    },
    ...
    #     "extractor_positions": [["Any", "Any", "Any"]],
    # },
    ...
    #     "extractor_positions": [["Any", "Any", "Any", "Any"]],
    # },
