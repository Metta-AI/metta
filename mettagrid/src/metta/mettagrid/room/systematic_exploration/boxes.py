...
class BoxesTerrain(Room):
    ...
    def _build(self) -> np.ndarray:
        ...
        np.save(f"terrains/boxes/{label}/{self.rng.integers(1000000)}.npy", grid)
...
#         num_boxes = np.random.randint(10, 30)
#         box_width = np.random.randint(5, 15)
#         box_height = np.random.randint(5, 15)
#         altars_per_box = np.random.randint(1, 3)
