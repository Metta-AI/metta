...
# You can run these functions locally with e.g. `./tools/run.py experiments.recipes.scratchpad.bullm.train`
...
def evaluate(
    policy_uri: str = "s3://your-bucket/checkpoints/local.bullm.1/local.bullm.1:v10.pt",
) -> EvaluateTool:
