...
class StatsExtractor:
    ...
    def extract_from_replay_data(self, replay_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        # Check if episode_stats are already provided (pre-computed)
        if "episode_stats" in replay_data:
            return replay_data["episode_stats"]

        # Otherwise, extract episode stats from raw replay data
        ...
        # Extract stats from objects/grid_objects format
        episode_stats = {
