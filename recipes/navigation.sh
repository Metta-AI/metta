...
./devops/skypilot/launch.py train run=$USER.navigation.low_reward.baseline  trainer.curriculum=env/mettagrid/curriculum/navigation/low_reward --gpus=1 +trainer.env_overrides.game.num_agents=4 \
