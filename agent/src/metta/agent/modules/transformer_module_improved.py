...
class TransformerModuleImproved(nn.Module):
    ...
    def __init__(
        ...
        self.positional_encoding = ImprovedPositionalEncoding(
            d_model, max_seq_len, dropout, scale_factor=pos_scale, learnable=learnable_pos
        )
        ...
        self.layers = nn.ModuleList(
            [
                ImprovedTransformerBlock(d_model, n_heads, d_ff, dropout, use_causal_mask, use_gating, activation)
