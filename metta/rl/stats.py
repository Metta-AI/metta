...
def process_policy_evaluator_stats(
    ...
    # Clean run_name to remove version suffix (e.g., ":latest", ":v7") for wandb run ID
    # wandb doesn't allow colons in run IDs
    clean_run_name = run_name.split(":")[0] if run_name else run_name
