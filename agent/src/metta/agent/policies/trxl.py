...
class TRXLConfig(PolicyArchitecture):
    """CortexTD-based TRXL policy using ViT tokenization and X attention layers."""
    ...
    _actor_hidden = 256
    _critic_hidden = 512
    _memory_num_layers = 2  # X layers; adjust as needed
    _xl_mem_len = 128  # set XL memory length via override_global_configs
