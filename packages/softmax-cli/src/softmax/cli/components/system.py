...
from softmax.cli.components.system_packages.installers.base import PackageInstaller
from softmax.cli.components.system_packages.installers.brew import BrewInstaller
from softmax.cli.components.system_packages.types import SystemDepsConfig
...
def get_system_deps_config() -> SystemDepsConfig:
    config_path = Path(__file__).resolve().parent / "system_packages" / "deps.yaml"
