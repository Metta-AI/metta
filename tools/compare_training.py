...
def run_hydra_training(run_name: str, run_dir: str, group: str) -> subprocess.Popen:
    ...
    cmd = [
        ...
        "trainer.ppo.gae_lambda=0.95",
        "trainer.ppo.max_grad_norm=0.5",
        ...
        "trainer.async_factor=2",
        "trainer.grad_mean_variance_interval=150",
        "trainer.scale_batches_by_world_size=false",
        "trainer.cpu_offload=false",
        "trainer.zero_copy=true",
    ]
