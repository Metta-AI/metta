...
from metta.mettagrid.mapgen.random.float import FloatConstantDistribution, FloatUniformDistribution
from metta.mettagrid.mapgen.random.int import IntConstantDistribution, IntUniformDistribution
from metta.mettagrid.mapgen.scenes.auto import (
    Auto,
    AutoParams,
    AutoParamsBSP,
    AutoParamsGrid,
