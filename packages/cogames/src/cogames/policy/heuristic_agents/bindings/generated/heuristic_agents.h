...
void heuristic_agents_heuristic_agent_step(HeuristicAgent agent, long long num_agents, long long num_tokens, long long size_token, pointer row_observations, long long num_actions, pointer raw_actions);
