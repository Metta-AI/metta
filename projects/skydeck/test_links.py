...
async def test_links():
    ...
    async with async_playwright() as p:
        ...
        if obs_pills:
            ...
            # Verify format
            expected_base = ServiceEndpoints.OBSERVATORY_API.replace("https://", "")
            if f"{expected_base}/stats/policies?name_fuzzy=" in clipboard_text:
                print("  ✓ URL format is correct (uses Observatory API with name_fuzzy)")
            else:
