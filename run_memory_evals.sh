...
POLICIES=(
  "daphne.navsequence.all.fromnumpy.sky.12agents"
  "daphne.navsequence.all.fromnumpy.sky.4agents"
  "daphne.navsequence.all.fromnumpy.sky"
  "daphne.3test.fromnumpy"
  "daphne.navsequence.bucketed4"
  "daphne.navsequence.bucketed3"
  "daphne.navsequence.bucketed2"
  "daphne.navigation.bucketed"
