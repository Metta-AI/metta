...
class Simulation:
    ...
    def __init__(
        ...
        metta_agent: MettaAgent | DistributedMettaAgent | MettaAgentAdapter = self._policy_pr.policy_as_metta_agent()
        assert isinstance(metta_agent, (MettaAgent, DistributedMettaAgent, MettaAgentAdapter)), metta_agent
