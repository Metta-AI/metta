...
Play an easy mission in Cogs vs. Clips using `cogames tutorial`. Follow the instructions given in the terminal, while you use the GUI to accomplish your first training mission.
