...
from metta.mettagrid.env_config import EnvConfig


class CurriculumTask:
    """A task instance with a task_id and env_cfg."""

    def __init__(self, curriculum: "Curriculum", task_id: int, env_cfg: EnvConfig):
...
class CurriculumConfig(ConfigWithBuilder):
    ...
    def validate_num_active_tasks(self, v, info):
        if v > self.max_task_id:
...
class Curriculum:
    ...
    def _create_task(self) -> CurriculumTask:
        ...
        task = CurriculumTask(self, task_id, env_cfg)
