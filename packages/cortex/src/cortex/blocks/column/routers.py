...
class BaseRouter(nn.Module):
    ...
    def forward(self, expert_outputs: list[cortex.types.Tensor]) -> cortex.types.Tensor:  # shape: [K]
...
class GlobalContextRouter(BaseRouter):
    ...
    def __init__(self, d_hidden: int, num_experts: int, cfg: cortex.config.RouterConfig) -> None:
        super().__init__()
    ...
    @torch.no_grad()
    def _topk_mask(self, scores: cortex.types.Tensor) -> cortex.types.Tensor:
    ...
    def _global_scores(self) -> cortex.types.Tensor:
    ...
    def global_logits(self, *, restrict_topk: bool = True) -> cortex.types.Tensor:
    ...
    def forward(self, expert_outputs: list[cortex.types.Tensor]) -> cortex.types.Tensor:
...
class TokenRefiner(nn.Module):
    ...
    def forward(self, x_tokens: cortex.types.Tensor) -> cortex.types.Tensor:
