...
class BiomeCityConfig(SceneConfig):
    ...
    pitch: int = 12  # distance between block starts
    road_width: int = 3  # empty corridors
    place_prob: float = 0.7  # probability to place a block in a cell
    min_block_frac: float = 0.45  # fraction of pitch used for block (before jitter)
