...
def test_multi_agent_gym_env(simple_config):
    ...
    curriculum = single_task_tree("gym_multi_test", simple_config)
...
def test_single_agent_gym_env(simple_config):
    ...
    curriculum = single_task_tree("gym_single_test", simple_config)
...
def test_gym_env_episode_termination(simple_config):
    ...
    curriculum = single_task_tree("gym_termination_test", simple_config)
    env = MettaGridGymEnv(
        curriculum=curriculum,
        render_mode=None,
        is_training=False,
