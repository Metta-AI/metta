...
POLICIES=(
    ...
    "b.georgedeane.terrain_multienv:v33"
    "b.georgedeane.terrain_newmaps_pretrained:v41"
    "b.daphne.navigation_terrain_training_v2:v63"
    "b.georgedeane.navigation_terrain_training_v2:v99"
    "b.daphne.navigation_terrain_training:v118"
    "b.daphne.terrain_newmaps2:v50"
    "b.georgedeane.terrain_newmaps:v31"
    "b.daphne.terrain_multienv_muon"
