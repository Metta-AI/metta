...
def test_visitation_counts_enabled(env_with_visitation):
    ...
    visitation_feature_id = env_with_visitation._c_sim.feature_spec()["agent:visitation_counts"]["id"]
...
def test_visitation_counts_disabled(env_without_visitation):
    ...
    visitation_feature_id = env_without_visitation._c_sim.feature_spec()["agent:visitation_counts"]["id"]
...
def test_visitation_counts_default_disabled(env_default):
    ...
    visitation_feature_id = env_default._c_sim.feature_spec()["agent:visitation_counts"]["id"]
