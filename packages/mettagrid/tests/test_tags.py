...
from mettagrid.config.mettagrid_config import AgentConfig, GameConfig
from mettagrid.core import MettaGridCore
from mettagrid.map_builder.ascii import AsciiMapBuilder
from mettagrid.test_support import TokenTypes

NUM_OBS_TOKENS = 200
TAG_ID_OFFSET = 0  # Tags start at ID 0
TAG_FEATURE_ID = 14  # ObservationFeature::Tag value from constants.hpp
...
class TestTags:
    ...
    def test_tags_in_config(self, env_with_tags):
        ...
        # Check for tag features (feature_id == TAG_FEATURE_ID) at wall locations
        tag_features = []
        for token in agent0_obs:
    ...
    def test_tags_in_observations(self, env_with_tags):
        ...
        # and assigned IDs starting from TAG_ID_OFFSET
        # Sorted: ["blocking", "solid"]
        expected_tag_ids = [TAG_ID_OFFSET, TAG_ID_OFFSET + 1]  # 0, 1
    ...
    def test_duplicate_tags_across_objects(self, env_with_duplicate_tags):
        ...
        shared_tag_id = TAG_ID_OFFSET + 1  # "shared_tag" should be ID 1
    ...
    def test_many_tags_on_single_object(self):
        ...
        # Tag IDs should be consecutive starting from TAG_ID_OFFSET
        expected_ids = set(range(TAG_ID_OFFSET, TAG_ID_OFFSET + 10))
