...
export const MapEditor: FC<{ charToName: Record<string, string> }> = ({
  charToName,
}) => {
  ...
  const encoding = useMemo(() => new AsciiEncoding(charToName), [charToName]);
  ...
  return (
    <div className="flex h-screen">
      {/* Left Sidebar */}
      <div className="w-96 border-r border-gray-300 bg-gray-50 p-4">
        <div className="mb-4">
      ...
      <Tabs
        ...
        additionalTabBarContent={
          <div className="flex items-center gap-4">
            <Button
              onClick={() => {
                navigator.clipboard.writeText(grid.toAscii(encoding));
              }}
              theme="primary"
              size="sm"
            >
