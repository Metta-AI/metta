...
def main():
    ...
    # Enable change_glyph for GUI control, but create a policy config without it for random actions
    cfg.game.actions.change_glyph.enabled = True
    cfg.game.actions.change_glyph.number_of_glyphs = 10
