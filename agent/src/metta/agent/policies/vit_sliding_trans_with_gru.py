...
from metta.agent.components.sliding_transformer_with_gru import SlidingTransformerWithGRUConfig
from metta.agent.policy import PolicyArchitecture

logger = logging.getLogger(__name__)


class ViTSlidingTransWithGRUConfig(PolicyArchitecture):
    ...
    components: List[ComponentConfig] = [
        ...
        SlidingTransformerWithGRUConfig(
            in_key="encoded_obs",
            out_key="core",
            output_dim=_core_out_dim,
            num_layers=_memory_num_layers,
            gru_hidden_dim=_core_out_dim,
            gru_num_layers=_gru_num_layers,
        ),
        MLPConfig(
            in_key="core",
            out_key="values",
