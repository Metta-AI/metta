...
register(
    BenchmarkDefinition(
        key="axons",
        title="Axons (streaming RTU) Triton vs PyTorch Benchmark",
        description="Benchmark the Axons cell with forced backend selection to compare Triton and PyTorch paths.",
        configs=CONFIGS,
        format_config=_format_config,
        run_case=_run_case,
        notes="Mirrors the previous Axons benchmark; includes segmented-scan cases with resets enabled.",
    )
)
