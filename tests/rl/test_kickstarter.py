...
class TestKickstarter:
    ...
    def test_loss_with_annealing(
        ...
        # We can't directly compare LSTMState objects, so just check that _forward was called once
        ...
        # We can't directly compare the LSTMState object, so we skip checking the third argument
