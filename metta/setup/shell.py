...
def help_configs() -> None:
    ...
    info('artifact = load_mpt("file://./train_dir/my_run/checkpoints/my_run:v12/policy.mpt")')
    info('artifact = load_mpt("s3://bucket/path/my_run/checkpoints/my_run:v12/policy.mpt")')
