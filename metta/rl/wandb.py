...
def upload_checkpoint_as_artifact(
    ...
    """Upload a checkpoint file to wandb as an artifact. This is a minimal implementation of the wandb artifact upload functionality that was previously in PolicyStore. It handles the core use case of uploading trained model checkpoints to wandb for sharing and versioning."""
    if not wandb:
