...
class TestEvalTaskOrchestratorIntegration:
    ...
    def _create_managed_worker(
        ...
        worker_client = http_eval_task_env.make_client()
    ...
    def create_success_worker(self, worker_name: str, http_eval_task_env: HttpEvalTaskClientEnv) -> EvalTaskWorker:
    ...
    @pytest.fixture
    def mock_thread_manager(self, http_eval_task_env: HttpEvalTaskClientEnv) -> ThreadWorkerManager:
        """Create a ThreadWorkerManager with mock workers."""

        def create_worker(worker_name: str) -> EvalTaskWorker:
            return self.create_success_worker(worker_name, http_eval_task_env)

        return ThreadWorkerManager(create_worker=create_worker)

    @pytest.fixture
    def orchestrator(
        self, mock_thread_manager: ThreadWorkerManager, http_eval_task_env: HttpEvalTaskClientEnv
    ...
    async def test_successful_task_processing(
        self, test_policy_id: uuid.UUID, http_eval_task_env: HttpEvalTaskClientEnv
    ):
    ...
    @pytest.mark.asyncio
    async def test_failed_task_processing(self, test_policy_id: uuid.UUID, http_eval_task_env: HttpEvalTaskClientEnv):
    ...
    @pytest.mark.asyncio
    async def test_worker_discovery_and_lifecycle(self, http_eval_task_env: HttpEvalTaskClientEnv):
    ...
    @pytest.mark.asyncio
    async def test_orchestrator_with_custom_worker_manager(self, http_eval_task_env: HttpEvalTaskClientEnv):
    ...
    @pytest.mark.asyncio
    async def test_kill_task_with_timeout(self, test_policy_id: uuid.UUID, http_eval_task_env: HttpEvalTaskClientEnv):
    ...
    @pytest.mark.asyncio
    async def test_kill_task_after_max_retries(
    ...
    @pytest.mark.asyncio
    async def test_kill_long_running_worker(self, test_policy_id: uuid.UUID, http_eval_task_env: HttpEvalTaskClientEnv):
    ...
    @pytest.mark.asyncio
    async def test_git_hash_task_affinity(self, http_eval_task_env: HttpEvalTaskClientEnv, test_policy_id: uuid.UUID):
    ...
    @pytest.mark.asyncio
    async def test_worker_idle_timeout_behavior(
        self, test_policy_id: uuid.UUID, http_eval_task_env: HttpEvalTaskClientEnv
    ):
