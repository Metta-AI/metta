...
class TMaze(Room):
    ...
    def _build_down_orientation(self) -> Tuple[Tuple[int, int], Tuple[int, int], Tuple[int, int], List[Tuple[int, int]]]:
    ...
    def _build_left_orientation(self) -> Tuple[Tuple[int, int], Tuple[int, int], Tuple[int, int], List[Tuple[int, int]]]:
    ...
    def _build_right_orientation(self) -> Tuple[Tuple[int, int], Tuple[int, int], Tuple[int, int], List[Tuple[int, int]]]:
