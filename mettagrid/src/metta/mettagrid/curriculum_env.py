...
class CurriculumEnv(AutoResetEnv):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        env_config = self._get_next_env_config()
    ...
    def _get_next_env_config(self) -> EnvConfig:
        """Get the next task from curriculum and get its EnvConfig."""
        self._current_task = self._curriculum.get_task()
        return self._current_task.env_config()
    ...
    def reset(self, seed: Optional[int] = None) -> Tuple[np.ndarray, Dict[str, Any]]:
        ...
        """
        # Get next task and update environment config
        env_config = self._get_next_env_config()
